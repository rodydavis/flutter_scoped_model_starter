...
class DessertDataSource extends CustomDataTableSource {
  ...
  CustomDataRow getRow(int index) {
    ...
    return CustomDataRow.byIndex(
        ...
        cells: <CustomDataCell>[
          CustomDataCell(Text('${dessert.name}')),
          CustomDataCell(Text('${dessert.calories}')),
          CustomDataCell(Text('${dessert.fat.toStringAsFixed(1)}')),
          CustomDataCell(Text('${dessert.carbs}')),
          CustomDataCell(Text('${dessert.protein.toStringAsFixed(1)}')),
          CustomDataCell(Text('${dessert.sodium}')),
          CustomDataCell(Text('${dessert.calcium}%')),
          CustomDataCell(Text('${dessert.iron}%')),
        ]);
  }
