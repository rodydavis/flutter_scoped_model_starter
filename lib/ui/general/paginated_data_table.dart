...
class NativePaginatedDataTable extends StatefulWidget {
  ...
  /// particular [NativePaginatedDataTable] widget is created; avoid creating a new
  /// [CustomDataTableSource] with each new instance of the [NativePaginatedDataTable]
  ...
  /// Scrolling ListView with Fixed Header and Footer
  ...
  /// [NativePaginatedDataTable] widget itself; it should be reused each time the
  /// [NativePaginatedDataTable] constructor is called.
  final CustomDataTableSource source;

  @override
  NativePaginatedDataTableState createState() =>
      NativePaginatedDataTableState();
}

/// Holds the state of a [NativePaginatedDataTable].
///
/// The table can be programmatically paged using the [pageTo] method.
class NativePaginatedDataTableState extends State<NativePaginatedDataTable> {
  int _firstRowIndex;
  int _rowCount;
  ...
  @override
  void didUpdateWidget(NativePaginatedDataTable oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    footerWidgets.addAll(<Widget>[
      ...
      Text(
        ...
        textScaleFactor: _size.width < 480 ? 0.8 : 1.0,
      ),
      Container(width: 32.0),
      IconButton(
