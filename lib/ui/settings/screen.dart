...
class _State extends State<SettingsPage> {
  ...
  // Todo: Always Show Data Tables...
  // Todo: Navigation Options...
  // Todo: Data Tables off, show master detail, with split view options
  // Todo: Preference for Search (Advanced or Simple)
              ...
              ListTile(
                ...
                trailing: Switch(
                  ...
                  onChanged: (bool value) {
                    ...
                    if (value != null) {
                      if (value) {
                        _app.darkMode(trueBlack: _trueBlack);
                      } else {
                        _app.lightMode();
                      }
                    }
